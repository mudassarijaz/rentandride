 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'hr_api1.nexvistech.com' : 'Adi_api1.adilocksmithinc.com';
$config['APIPassword'] = $config['Sandbox'] ? '5GNEYMFS24VMH6RE' : '3SL6V3JEPB76ZXS8';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AZoOk-sCuchnCKXvvdzedVEHdIXZ' : 'AQU0e5vuZCvSg-XJploSa.sGUDlpAADVF4EdPryxxvCEsy.39yVj4Gsy';
