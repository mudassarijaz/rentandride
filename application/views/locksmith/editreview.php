    ...
    <div class="col-md-8 col-md-offset-3">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" action="<?php echo base_url(); ?>locksmith/editreview/<?php echo $reviews->id; ?>" method="post">
            <fieldset>
              <div class="form-group">
                <label>Customer</label>
                <input type="text" class="form-control" id="customer" name="customer" placeholder="Add Customer" value="<?php if(isset($reviews->customer_name)&&!empty($reviews->customer_name)){echo $reviews->customer_name;}elseif(isset($_POST['customer_name'])&&!empty($_POST['customer_name'])){echo $_POST['customer_name'];} ?>" />
              ...
              <a href="/locksmith/reviews" id="cancel" name="cancel" class="btn btn-default">Cancel</a>
            </fieldset>
          </form>
        </div>
      </div>
