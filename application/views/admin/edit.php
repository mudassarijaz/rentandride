          ...
          <form action="<?php echo base_url(); ?>admin/edit" method="post" enctype="multipart/form-data">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name[]" value="<?php if(isset($name[1])&&!empty($name[1])){ echo $name[1];} ?>" />
              </div>
              <div class="form-group">
                <label>Email</label>
              ...
              <a href="/admin/profile" id="cancel" name="cancel" class="btn btn-default">Cancel</a>
            </fieldset>
          </form>
        </div>
      </div>
