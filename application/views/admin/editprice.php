    ...
    <div class="col-md-8 col-md-offset-3">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" action="<?php echo base_url(); ?>admin/editprice/<?php echo $prices->id; ?>" method="post">
            <fieldset>
              ...
              <a href="/admin/prices/<?php echo $prices->user_id; ?>" id="cancel" name="cancel" class="btn btn-default">Cancel</a>
            </fieldset>
          </form>
        </div>
      </div>
